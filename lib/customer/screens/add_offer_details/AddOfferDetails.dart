        ...
        child: Column(
          children: [
            ...
            DropdownTextField<Category>(
              dropKey: dept,
              label: tr(context, "nameDept"),
              useName: true,
              selectedItem: widget.model.category,
              // showSelectedItem: true,
              margin: EdgeInsets.symmetric(vertical: 5),
              validate: (value) =>
                  Validator(context).validateDropDown<Category>(model: value),
  ...
  Widget _buildPropertyType(
    ...
    if (model.type == 2) {
      ...
      return DropdownTextField<PropertyModel>(
        ...
        validate: (value) =>
            Validator(context).validateDropDown<PropertyModel>(model: value),
        data: model.props,
