...
class OfferDetailsData {
  ...
  void setAddOffer(BuildContext context, AddAdsModel model) {
    ...
    if (valid != null && adsPhoneCubit.state.showPhone) {
      LoadingDialog.showSimpleToast(tr(context, "addPhone"));
      return;
    }
    if (title.text.isEmpty) {
      LoadingDialog.showSimpleToast(tr(context, "addAdsTitle"));
      return;
    }
    if (price.text.isEmpty && adsPhoneCubit.state.showPrice) {
      LoadingDialog.showSimpleToast(tr(context, "addAdsPrice"));
      return;
    }
    if (lastCat == null) {
      LoadingDialog.showSimpleToast(tr(context, "addAdsDept"));
      return;
    }
