...
class Chat extends StatefulWidget {
  ...
  const Chat({@required this.senderId,@required this.receiverId,@required  this.userName});
  @override
...
class _ChatState extends State<Chat> with ChatData {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: DefaultAppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.info_outline_rounded,size: 25,color: MyColors.white,),
  ...
  Widget _buildRightMsg(MessageModel model,UserModel user){
    return Container(
      ...
      child: Column(
        ...
        children: [
          MyText(title: user.userName,size: 8,color: MyColors.blackOpacity,),
          ConstrainedBox(
            ...
            child: Container(
              ...
              child: MyText(title: model.message ,size: 9,color: MyColors.white,),
            ),
          )
        ],
      ),
  ...
  Widget _buildLeftMsg(MessageModel model){
    return Container(
      ...
      child: Column(
        ...
        children: [
          InkWell(
            onTap: ()=> AutoRouter.of(context).push(UserProductsRoute(userId: model.receiverId,userName: widget.userName)),
            child: MyText(title: widget.userName,size: 8,color: MyColors.blackOpacity,),
          ),
          ConstrainedBox(
            constraints: BoxConstraints(
              maxHeight: MediaQuery.of(context).size.height,
            ...
            child: Container(
              ...
              child: MyText(title: model.message ,size: 9,color: MyColors.blackOpacity,),
            ),
          )
        ],
      ),
  ...
  Widget _buildChatInput(){
    return ChatTextField(
      ...
      submit: ()=> sendChatMessage(widget.receiverId,widget.senderId,context),
    );
  }
        ...
        return  AlertDialog(
          ...
          title: Container(
            ...
            child: Row(
              ...
              children: [
                MyText(title: "بلاغ",size: 12,color: Colors.white,),
                InkWell(
          ...
          content: Container(
            child: Column(
              ...
              children: [
                ...
                DefaultButton(title: "ارسال", onTap: ()=>setAddReport(context,widget.receiverId))
              ],
            ),
          ),
