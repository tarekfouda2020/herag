...
class _ProductDetailsState extends State<ProductDetails> with ProDetailsData {
  ...
  void initState() {
    if (widget.info != null) {
      productDetailsCubit.onModelUpdated(
          AdsDetailsModel(adsData: widget.info, relatedAds: []),
          favouriteCubit,
          commentCubit);
    } else {
      productDetailsCubit.fetchAdsDetails(
          context, widget.model.id, favouriteCubit, commentCubit,
          refresh: false);
    }
    productDetailsCubit.fetchAdsDetails(
        context, widget.model.id, favouriteCubit, commentCubit);
            ...
            children: [
              ...
              Visibility(
                ...
                child: Container(
                    ...
                    child: MyText(
                      title: "${data.price} ${tr(context, "sar")}",
                      size: 9,
                      color: MyColors.white,
                    )),
              )
                  ...
                  child: BlocBuilder<FavouriteCubit, FavouriteState>(
                    ...
                    builder: (context, state) {
                      return TitleButton(
                        ...
                        iconData: Icons.wifi,
                        title: tr(context, "followAds"),
                        iconColor:
                            state.follow ? MyColors.primary : Colors.black87,
      ...
      child: Column(
        ...
        children: [
          ...
          _buildContactItem(
              ...
              title: "${tr(context, "rate")}  ${data.userRate}",
              onTab: null),
          _buildContactItem(
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: MyText(
                    title: tr(context, "sellFaceToFace"),
                    size: 11,
                    color: MyColors.blackOpacity,
                  ),
                )
            ...
            children: [
              ...
              Visibility(
                ...
                child: DefaultButton(
                  ...
                  title: tr(context, "displayAllComments"),
                  color: MyColors.primary,
  ...
  void _buildConfirmRemoveReply(ReplyModel model, int index) {
    LoadingDialog.showConfirmDialog(
        context: context,
        title: tr(context, "confirmDeleteReply"),
      ...
      return Column(
        ...
        children: [
          Padding(
            ...
            child: MyText(
              title:
                  "${tr(context, "similarAds")} ${relatedAds.length} ${tr(context, "ads")}",
              size: 12,
              color: MyColors.black,
            ),
          ),
