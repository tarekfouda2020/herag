...
class EditOfferLocData{
  ...
  void navigateToAddDetails(UpdateAdModel model,AdsDataModel adsDataModel,BuildContext context){
    if(formKey.currentState.validate()){
      ...
      AutoRouter.of(context).push(EditOfferDetailsRoute(model: model,adModel: adsDataModel)
      );
    }
  }
