...
class _EditProfileState extends State<EditProfile> with EditProfileData {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: DefaultAppBar(title: tr(context, "myAccount"), con: context),
      body: ListView(
        children: [
          Container(
            height: 200,
              ...
              child: Column(
                children: [
                  ...
                  LabelTextField(
                    ...
                    action: TextInputAction.next,
                    validate: (value) =>
                        Validator(context).validatePhone(value: value),
                  ...
                  LabelTextField(
                    ...
                    action: TextInputAction.next,
                    validate: (value) =>
                        Validator(context).validateEmailORNull(value: value),
                  ...
                  RichTextFiled(
                    ...
                    validate: (value) =>
                        Validator(context).noValidate(value: value),
