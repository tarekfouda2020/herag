  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: DefaultAppBar(
        ...
        actions: [
          IconButton(
            onPressed: ()=> AutoRouter.of(context).push(EditProfileRoute(user: user)),
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    MyText(title: " مشترك ${state.model.publishDate} ",size: 10,color: MyColors.blackOpacity,),
                    RatingBar.builder(
        ...
        if(state is CommentUpdated){
          return Flexible(
            child: CustomPullRefresh(
              ...
              onRefresh: ()=>commentCubit..setRefreshData(context,refreshController),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Visibility(
              visible: false,
              child: Icon(Icons.thumb_up_alt,size: 20,color: Colors.black87,)
          )
        ],
      ),
    );
